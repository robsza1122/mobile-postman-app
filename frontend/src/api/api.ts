...
import { multiAdvicedStatusType, multiDeliverStatusType } from "../utils/helpers/statusObjects.ts";
...
//Infos about status
export const getCheckStatus = async (id: string) => API.post(`/checkStatus/${id}`);
