...
exports.otherStatusEmail = void 0;
const otherStatusEmail = (parcel, url) => {
    const details = parcel?.status?.[parcel?.status?.length - 1]?.details;
    const handleTitle = (detailedInfo) => {
        switch (detailedInfo) {
...
exports.otherStatusEmail = otherStatusEmail;
