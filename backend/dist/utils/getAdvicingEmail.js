...
exports.getAdvicingEmail = void 0;
const getAdvicingEmail = (parcel, url) => {
    const baseUrl = url.split("/status")[0] || url.split("/")[0] + "//" + url.split("/")[2];
...
exports.getAdvicingEmail = getAdvicingEmail;
